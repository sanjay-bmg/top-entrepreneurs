...
export default function PricingEstimate({
  ...
  // Taken cities can't be purchased — keep them out of the quote total too
  ...
  // One Top Spot slot per city — build the per-city grid
  const featuredGrid =
      ...
      {featuredGrid.length > 0 && (
        <div className="border-t border-gold/20 pt-4 space-y-2">
          <p className="text-xs font-semibold text-navy">
            Top Spot — {formatCurrency(PRICING.featuredCity)} / city
          </p>
          ...
          {hasTaken && (
            <p className="text-xs text-red-600 mt-1">
              The Top Spot is already claimed in one or more of your cities.{" "}
